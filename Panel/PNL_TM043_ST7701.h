//----------------------------------------------------------------------------------------------------
// ID Code      : PNL_TM043_ST7701.h
// Description  : Tianma 4.3" 480x800 ST7701 IPS Panel (24-bit TTL RGB Interface)
//----------------------------------------------------------------------------------------------------
...
#define _DISP_LEN                       854

#define _DH_ACT_STA_POS                 56
#define _DH_ACT_END_POS                 (_DISP_WID + _DH_ACT_STA_POS)

#define _DV_ACT_STA_POS                 17
...
//--------------------------------------------------
#define _STD_DH_TOTAL                   672
#define _STD_DV_TOTAL                   899
...
//--------------------------------------------------
// Definitions for Display Signal (Active-Low Syncs for ST7701)
//--------------------------------------------------
...
{
    // Exact 100% factory EHD-5008 480x854 EDID from live_dump @ 0x01E00
    ...
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x29, 0x0E, 0xE0, 0xC0, 0x10, 0x56, 0x2D, 0x30, 0x10, 0x50,
    ...
    0x00, 0x45, 0x48, 0x44, 0x2D, 0x35, 0x30, 0x30, 0x38, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x01, 0x17,
};
#endif
...
#endif // #if(_PANEL_TYPE == _PNL_TM043_ST7701)
